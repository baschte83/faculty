 ...
 * Purpose: solution to lab 01: ProfessorExistsException.java<br>
 * @author Sebastian Baumann, Korbinaian Karl, Seyed Ehsan Moslehi
 * @version 0.9
 */

public class ProfessorExistsException extends FacultyException {

    /**
     * Constructs a new ProfessorExistsException.
     */
    ...
    /**
     * Constructs a new ProfessorExistsException with the specified detail message.
     *
    ...
    /**
     * Constructs a new ProfessorExistsException with the specified cause and a detail message.
    ...
    /**
     *  Constructs a new ProfessorExistsException with the specified detail message and cause.
     * @param message the detail message.
     * @param cause the cause.
     */
